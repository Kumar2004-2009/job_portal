          ...
          {isEdit ? (
            <>
              ...
              <button
                ...
                className="bg-green-100 border border-green-400 px-4 py-2 rounded-lg cursor-pointer "
              >
                Save
              </button>
            </>
        ...
        <table className="min-w-full bg-white border border-gray-300 rounded-lg">
          <thead>
            <tr>
              ...
              <th className="py-3 px-4 border-b text-left border-gray-300 max-sm:hidden">
                Location
              </th>
